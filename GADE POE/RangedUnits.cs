...
namespace GADE_POE
{
    ...
    class RangedUnits : Unit
    {
        ...
        public RangedUnits(string nam, int X_position, int Y_position, int Health, int Attack, int Speed, int Attack_range, int Faction, string image)
        {
        ...
        {
            return "RANGED UNIT:  " + name + " ," + Xpos + " ," + Ypos + " ," + Health + " ,";
        }
